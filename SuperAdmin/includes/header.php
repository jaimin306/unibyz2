...
<?php
  ...
  $select_user = "SELECT * FROM tbl_user WHERE id = '$user_id'";
...
<header class="main-header"> 
    ...
    <span class="logo-lg"><b><?php echo GetSettingGeneral('company_name'); ?></b></span> </a> 
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-user"></i> <span class="hidden-xs"><?php echo $user_name; ?></span> </a>
            <ul class="dropdown-menu">
              <li class="user-header"> <img src="../dist/img/john_slatter.png" class="img-circle" alt="User Image">
