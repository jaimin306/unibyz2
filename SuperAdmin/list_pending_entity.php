      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Pending Entity</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">All Pending Entity</h3>
                    ...
                    <table id="datatable" class="table table-bordered table-striped" style="width:100%">
                      ...
                      <tbody>
                        <?php
                          ...
                          $query = "SELECT tu.*,tu.id,tc.company_name,tc.company_logo FROM tbl_user tu LEFT JOIN tbl_company_detail tc ON tc.user_id = tu.id WHERE tu.status = '1' AND tu.user_type = '1' AND tu.user_status = '1' AND tu.id NOT IN ($uid) ";
            ...
            if (confirmDelete()) {
              ...
              $.ajax({
                  ...
                  success:function(data){
                      if(data.result == "true"){
                          window.location.href="list_pending_entity.php?status="+(data.status);
                      }
                      else{
                          window.location.href="list_pending_entity.php?status="+(data.status);
                      }
