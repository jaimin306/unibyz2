            ...
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">All Entity</h3>
                    ...
                    <table id="datatable" class="table table-bordered table-striped" style="width:100%">
                      ...
                      <tbody>
                        <?php
                          ...
                          $query = "SELECT tu.*,tu.id,tc.company_name,tc.company_logo FROM tbl_user tu LEFT JOIN tbl_company_detail tc ON tc.user_id = tu.id WHERE tu.status = '1' AND tu.user_type = '1' AND tu.id NOT IN ($uid);";
                          ...
                          if($num_rows > 0){
                            ...
                            while($row = mysqli_fetch_assoc($res)){
                              ?>
                                <tr>
                                  <td><?php echo $i; ?></td>
                                  <td><?php echo $row["company_name"]; if($row["company_logo"] != ""){echo '<br><a data-fancybox="gallery" href="../uploads/logo/'.$row["company_logo"].'"><img src="../uploads/logo/'.$row["company_logo"].'" height="70px" width="65%"/></a>';}?></td>
