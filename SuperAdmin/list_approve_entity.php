      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Approved Entity</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">All Approved Entity</h3>
                    ...
                    <table id="datatable" class="table table-bordered table-striped" style="width:100%">
                      ...
                      <tbody>
                        <?php
                          ...
                          $query = "SELECT tu.*,tu.id,tc.company_name,tc.company_logo FROM tbl_user tu LEFT JOIN tbl_company_detail tc ON tc.user_id = tu.id WHERE tu.status = '1' AND tu.user_type = '1' AND tu.user_status = '0' AND tu.id NOT IN ($uid) ";
