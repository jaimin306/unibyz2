              ...
              <div class="container">
                <form role="form" method="post" id="ticket_form" class="form-horizontal"  action="#" onsubmit="return submitForm();" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <select class="form-control" name="project_id" id="project_id" >
                          ...
                          <?php 
                          $query_project = "SELECT id,project_name FROM tbl_project WHERE status = '1' AND add_uid IN (select add_uid from tbl_user where id = '$uid_ticket')";
                      ...
                      <div class="col-md-4">
                        <select class="form-control" name="ticket_department_id" id="ticket_department_id" >
                          ...
                          <?php 
                          $query_department = "SELECT id,department_name FROM tbl_ticket_department WHERE status = '1' AND add_uid IN (select add_uid from tbl_user where id = '$uid_ticket')";
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                          <select class="form-control" name="ticket_status_id" id="ticket_status_id" >
                              ...
                              <?php 
                                  $query_status = "SELECT id,status_name FROM tbl_ticket_status WHERE status = '1' AND add_uid IN (select add_uid from tbl_user where id = '$uid_ticket')";
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select name="notify_to" id="notify_to" class="form-control">
                                ...
                                <option value="1" <?php echo ($row["notify_to"] == "1" ? 'selected' : '') ?>>Admin</option>
                    ...
                    <div class="form-group">
                      <label for="ticket_message" class="control-label col-md-2">Incident Message </label>
                      <div class="col-md-10">
