...
<aside class="main-sidebar">
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="<?php echo ($activePage == 'list_project') ? 'active':''; ?>"><a href="list_project.php"><i class="fa fa-bookmark-o"></i> Projects</a></li>

			<li class="treeview <?php echo ($activePage == 'list_milestone' || $activePage == 'milestone' ) ? 'active':''; ?>"> <a href="javascript:void(0)"> <i class="fa fa-clock-o"></i> <span>Project Milestone</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
				<ul class="treeview-menu">
					<li class="<?php echo ($activePage == 'milestone') ? 'active':''; ?>"><a href="milestone.php"><i class="fa fa-circle-o"></i>Create New Milestone</a></li>
					<li class="<?php echo ($activePage == 'list_milestone') ? 'active':''; ?>"><a href="list_milestone.php"><i class="fa fa-circle-o"></i>View All Milestone</a></li>
				</ul>
			</li>
