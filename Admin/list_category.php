...
if (!empty($_GET['status'])) {
    switch ($_GET['status']) {
        ...
        case 'error':
            ...
            $statusMsg      = 'Error In Category... Please Try Again';
            break;
        default:
            $statusMsgClass = '';
            $statusMsg      = '';
                        ...
                        <div class="col-md-12">
                          <div class="box box-primary">
                            <div class="box-header with-border">
                              ...
                              <a href="category.php"><button class="btn btn-primary pull-right btn-sm"><i class="fa fa-plus"></i>&nbsp; Add Category</button></a>
                            </div>
                            <div class="container">
                              ...
                              <div class="box-body">
                                <table id="datatable" class="table table-bordered table-striped" style="width:100%">
                                  ...
                                  <tbody>
                                    <?php
                                      $query = "SELECT * FROM tbl_category WHERE status = '1' AND add_uid = '$uid_category'";
                                                ...
                                                <div class="btn-group">
                                                  <button type="button" class="btn btn-info btn-sm"><b>Choose</b></button>
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                      <li><a href="category.php?EID=<?php echo encrypt($row['id']); ?>"><i class="fa fa-edit" ></i> &nbsp;Edit</a></li>
