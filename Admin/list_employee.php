...
if (!empty($_GET['status'])) {
      switch ($_GET['status']) {
          ...
          case 'usuccess':
              $statusMsgClass = 'alert-success';
              $statusMsg      = 'Employee Updated Successfully';
              break;
          case 'dsuccess':
              $statusMsgClass = 'alert-success';
          ...
          case 'upstatus':
              $statusMsgClass = 'alert-success';
              $statusMsg      = 'Employee Status Changed Successfully';
              break;
          case 'error':
              $statusMsgClass = 'alert-danger';
              $statusMsg      = 'Error In Employee... Please Try Again';
              break;
          default:
              $statusMsgClass = '';
              $statusMsg      = '';
                        ...
                        <div class="col-md-12">
                          <div class="box box-primary">
                            <div class="box-header with-border">
                              ...
                              <a href="employee.php"><button class="btn btn-primary pull-right btn-sm"><i class="fa fa-plus"></i>&nbsp; Add Employee</button></a>
                            </div>
                            <div class="container">
                                      ...
                                      if($num_rows > 0){
                                        ...
                                        while($row = mysqli_fetch_assoc($res)){
                                          ?>
                                            <tr>
                                              <td><?php echo $i; ?></td>
                                              <td><?php echo $row["first_name"]." ".$row["last_name"]; if($row["user_image"] != ""){echo '<br><a data-fancybox="gallery" href="../uploads/employee/'.$row["user_image"].'"><img src="../uploads/employee/'.$row["user_image"].'" height="65px" width="45%"/></a>';}?></td>
                                              <td><?php echo $row["phone"]; ?></td>
                                              <td><?php echo $row["email"]; ?></td>
                                              <td><?php echo $row["address"]; ?></td>
                                              <td><?php if($row["user_type"] == '3'){ echo '<span class="label label-primary">Project Manager</span>';}  if($row["user_type"] == '4'){ echo '<span class="label label-success">Employee</span>';} ?></td>
                                              <td>
                                              <?php 
                                                ...
                                                <div class="btn-group">
                                                  <button type="button" class="btn btn-info btn-sm"><b>Choose</b></button>
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                      ...
                                                      <li><a href="employee.php?EID=<?php echo encrypt($row['id']); ?>"><i class="fa fa-edit" ></i> &nbsp;Edit</a></li>
