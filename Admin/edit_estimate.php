    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Edit Estimate #<?php echo $id; ?></h3>
                                </div>
                                <div class="container">
                                    <form method="POST" id="estimate_form" class="form-horizontal" action="#" onsubmit="return submitForm();" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <textarea name="address_of_work" class="form-control"  placeholder="Enter Address Of Work To Be Performed Here"><?php echo (isset($id) ? $row['address_of_work'] : ''); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <select name="notify_department" id="notify_department" class="form-control" >
                                                    <option value="Yes" <?php echo ($row["notify_department"] == "Yes" ? 'selected' : ''); ?>>Yes</option>
                                                    <option value="No" <?php echo ($row["notify_department"] == "No" ? 'selected' : ''); ?> >No</option>
                                                </select>
                                            </div>                                          
                                        </div>
                                        <div class="form-group">                                            
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" id="estimate_date" value="<?php echo (isset($id) ? $row['estimate_date'] : ''); ?>" name="estimate_date" placeholder="Enter Estimate Date Here" >
                                            </div>  
                                            <label for="estimate_due_date" class="control-label col-md-2">Estimate Due Date</label>
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" id="estimate_due_date" value="<?php echo (isset($id) ? $row['estimate_due_date'] : ''); ?>" name="estimate_due_date" placeholder="Enter Quotation Due Date Here">    
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control"  value="<?php echo (isset($id) ? $row['technician_name'] : ''); ?>" id="technician_name" name="technician_name" placeholder="Enter Technician Name Here">
                                            </div>
                                            <label for="technician_number" class="control-label col-md-2">Technician Number</label>
                                            <div class="col-md-4">
                                                <input type="text" class="form-control"  value="<?php echo (isset($id) ? $row['technician_number'] : ''); ?>" id="technician_number" name="technician_number" placeholder="Enter Technician Number Here" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div id="replace_div">
        ...
        <script type="text/javascript">
            ...
            function submitForm() {    
                ...
                form_data.append("cmd", "UpdateEstimate");
            ...
            function GetEstimateTable(){
                //$("#hidden_spinner").show();
                var estimate_id = $("#hidden_id").val(); 
                $.ajax({
                    url: "ajax/estimate_table.php",
                    type: "POST",
                    data: {estimate_id:estimate_id,cmd:"GetEstimateTable"},
                    success:function(data){                        
