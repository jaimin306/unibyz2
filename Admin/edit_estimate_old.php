                                                    ...
                                                    while($row_sel = mysqli_fetch_assoc($res_sel)){
                                                        ...
                                                        <tr id="main_<?php echo $i; ?>">
                                                            <td style="width:100px">
                                                                <input type="hidden" value="<?php echo $row_sel["id"]?>" name="edit_hidden_estimate_id[]" >
                                                                <select name="sel" onchange="SetProduct(this.value,<?php echo $i ?>)" class="form-control" disabled>
                                                            ...
                                                            <?php
                                                                ...
                                                                $ppid = $row_sel["product_id"];
                                                                $query_product = "SELECT id,product_name FROM tbl_product WHERE status = '1' AND id = '$ppid'";
                                                                $res_product = mysqli_query($mysqli,$query_product) or fatal_error( 'MySQL Error: ' . mysqli_errno($mysqli));
                                                                $row_product2 = mysqli_fetch_assoc($res_product);
                                                            ?>
                                                                ...
                                                                <input type="text" class="form-control" name="product_id_disp[]" id="product_id_<?php echo $i ?>" <?php if($row_sel["product_detail"] != ""){ echo 'style="display: none"';}?> value="<?php echo $row_product2["product_name"]; ?>" readonly >
                                                                <input type="hidden" name="product_id[]" value="<?php echo $row_product2['id']; ?>"  />

                                                            </td>
                                                            <td>
                                                                <div id="mtype_<?php echo $i; ?>">
                                                                    <?php 
                                                                    if($row_sel["product_id"] != "" && $row_sel["product_id"] != "0"){
                                                                        ?>
                                                                        <select class="form-control" name="measurement_type[]" >
                                                                            <option value="">Select</option>
                                                                            <option value="Volume" <?php echo ($row_sel["measurement_type"] == "Volume" ? 'selected=selected' : ''); ?>>Volume</option>
                                                                            <option value="Length" <?php echo ($row_sel["measurement_type"] == "Length" ? 'selected=selected' : ''); ?>>Length</option>
                                                                            <option value="Area" <?php echo ($row_sel["measurement_type"] == "Area" ? 'selected=selected' : ''); ?>>Area</option>
                                                                            <option value="Weight" <?php echo ($row_sel["measurement_type"] == "Weight" ? 'selected=selected' : ''); ?>>Weight</option>
                                                                        </select>    
                                                                        <?php
                                                                    }
                                                                    else{
                                                                        ...
                                                                        <select class="form-control" name="measurement_type[]" >
                                                                        <option value="">Select</option>
                                                                            <option value="Time" <?php echo ($row_sel["measurement_type"] == "Time" ? 'selected=selected' : ''); ?>>Time</option>
                                                                        </select>    
                                                                        <?php
                                                                    }
                                                                    ?>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control" name="measurement[]" placeholder="Enter Measurement" value="<?php echo $row_sel["measurement"]; ?>" >
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td style="width:50px">
                                                                ...
                                                                if($i == 0){
                                                                    ...
                                                                    echo '<button class="btn btn-danger" type="button" onclick="RemoveBtn('.$i.','.$row_sel["id"].')" >-</button>';
                                                                }
                                                                ?>
                                                            </td>
                                                        </tr>
                                        ...
                                        <div class="box-footer">
                                            <?php
                                                if(isset($id) && $id != "" ){
                                                  ...
                                                  echo '<button type="submit" class="btn btn-primary" id="">Save</button>';
                                                }
                                                ?>
                                        </div>
                                        <?php
        ...
        <script type="text/javascript">
            ...
            function SetProduct(val,did){
                if(val == "Product"){
                  ...
                  $("#mtype_"+did).html('<select name="measurement_type[]" id="measurement_type" class="form-control mtp_0"><option value="">Select</option><option value="Volume">Volume</option><option value="Length">Length</option><option value="Area">Area</option><option value="Weight">Weight</option></select>');
                }
                else{
                  // $("#check_qty_filed").val("");
                  ...
                  $("#total_tax_"+did).val("");
                  $("#hidden_qty_"+did).val("");
                  $("#mtype_"+did).html('<select name="measurement_type[]" id="measurement_type" class="form-control mts_0"><option value="">Select</option><option value="Time">Time</option></select>');
                }
            }
