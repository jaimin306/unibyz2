                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                  <h3 class="box-title"><?php if(isset($id) && $id != ""){ echo 'Edit Tasks</h3>'; } else{ echo 'Add Tasks';} ?>
                                </div>
                                <div class="container">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                              <select class="form-control" name="project_id" onchange="GetMilestone(this.value)" id="project_id"  >
                                                  ...
                                                  <?php 
                                                      $query_project = "SELECT * FROM tbl_project WHERE status = '1' AND add_uid = '$uid_task'";
                                          ...
                                          <table class="table table-striped table-hover text-center" style="width:100%;border-collapse: collapse;table-layout: fixed" cellspacing="0" cellpadding="0" id="myTable">
                                            <tbody>
                                              ...
                                              <?php
                                                if(isset($row['id'])){ 
                                                  $i=0;
                                                  $query_task_product = "SELECT * FROM tbl_task_product WHERE task_id = $row[id] ORDER BY id";
                                                  ...
                                                  <?php
                                                    ...
                                                    if($sid != ""){
                                                        ...
                                                        if($sid == "Product") {                                                              
                                                            ...
                                                            $query = "SELECT tc.id,tc.category_name FROM tbl_category tc WHERE tc.add_uid = '$uid_task' AND tc.status = '1'";
                                                        } else {
                                                            $query = "SELECT tc.id,tc.category_name FROM tbl_service_category tc WHERE tc.status = '1' AND tc.add_uid = '$uid_task'";
                                                ...
                                                <td>
                                                  <?php 
                                                    ...
                                                    if($cid != ""){
                                                        ...
                                                        if($type == "Product") {
                                                            $query = "SELECT tpt.id,tpt.product_type_name as type_name FROM tbl_product_type tpt LEFT JOIN tbl_user tu ON tu.id = tpt.add_uid WHERE tpt.status = '1' AND tpt.category_id = '$cid' AND tu.id = '$uid_task'";
                                                            //$query = "SELECT tpt.id,tpt.product_type_name as type_name FROM tbl_product_type tpt WHERE tpt.status = '1' AND tpt.category_id = '$cid' AND tpt.add_uid = '$uid_task'";
                                                        } else {
                                                            $query = "SELECT tst.id,tst.service_type_name as type_name FROM tbl_service_type tst LEFT JOIN tbl_user tu ON tu.id = tst.add_uid WHERE tst.status = '1' AND tst.category_id = '$cid' AND tu.id = '$uid_task'";
                                                            //$query = "SELECT tst.id,tst.service_type_name as type_name FROM tbl_service_type tst WHERE tst.status = '1' AND tst.category_id = '$cid' AND tpt.add_uid = '$uid_task'";
                                                        }    
                                                        $t_res = mysqli_query($mysqli, $query) or fatal_error('MySQL Error: ' . mysqli_errno($mysqli));
                                                  ...
                                                  <?php 
                                                    ...
                                                    if($tid != ""){
                                                        ...
                                                        if($type == "Product"){
                                                            ...
                                                            $query = "SELECT tp.id,tp.product_name as pname FROM tbl_product tp WHERE tp.product_type_id = '$tid' AND tp.status = '1' AND tp.add_uid = '$uid_task'";
                                                        } else{
                                                            ...
                                                            $query = "SELECT ts.id,ts.service_name as pname FROM tbl_service ts WHERE ts.service_type_id = '$tid' AND ts.status = '1' AND ts.add_uid = '$uid_task'";    
                                                        }
                ...
                if(formid != "" && formid != "0"){
                  ...
                  $.ajax({
                      ...
                      success:function(data){
                          if(data.result == "true"){
                              window.location.href="view_project.php?VID="+(data.vid);
                          }
                          else{
                              window.location.href="list_project.php?VID="+(data.status);
                          }
                      }   
                  });
                  return false; 
