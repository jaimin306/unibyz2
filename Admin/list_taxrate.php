...
if (!empty($_GET['status'])) {
    switch ($_GET['status']) {
        case 'success':
            ...
            $statusMsg      = 'Tax Rate Added Successfully';
            break;
        case 'usuccess':
            $statusMsgClass = 'alert-success';
            $statusMsg      = 'Tax Rate Updated Successfully';
            break;
        case 'dsuccess':
            $statusMsgClass = 'alert-success';
            $statusMsg      = 'Tax Rate Deleted Successfully';
            break;
        case 'error':
            $statusMsgClass = 'alert-danger';
            $statusMsg      = 'Error In Tax Rate... Please Try Again';
            break;
        default:
            $statusMsgClass = '';
            $statusMsg      = '';
                        ...
                        <div class="col-md-12">
                          <div class="box box-primary">
                            <div class="box-header with-border">
                              <h3 class="box-title">All Tax Rate</h3>
                              <a href="taxrate.php"><button class="btn btn-primary pull-right btn-sm"><i class="fa fa-plus"></i>&nbsp; Add Tax Rate</button></a>
                            </div>
                            <div class="container">
                              ...
                              <div class="box-body">
                                <table id="datatable" class="table table-bordered table-striped" style="width:100%">
                                  ...
                                  <tbody>
                                    <?php
                                      $query = "SELECT * FROM tbl_taxrate WHERE status = '1' AND add_uid = '$uid_tr'";
                                                ...
                                                <div class="btn-group">
                                                  <button type="button" class="btn btn-info btn-sm"><b>Choose</b></button>
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                      <li><a href="taxrate.php?EID=<?php echo encrypt($row['id']); ?>"><i class="fa fa-edit" ></i> &nbsp;Edit</a></li>
