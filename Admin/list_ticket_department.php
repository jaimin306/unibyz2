...
if (!empty($_GET['status'])) {
    switch ($_GET['status']) {
        ...
        case 'ussuccess':
            $statusMsgClass = 'alert-success';
            $statusMsg      = 'Department Status Changed Successfully';
            break;
        case 'error':
            $statusMsgClass = 'alert-danger';
            $statusMsg      = 'Error In Department... Please Try Again';
            break;
        default:
            $statusMsgClass = '';
            $statusMsg      = '';
...
$uid_department = $_SESSION["user_id"];
?>
<!DOCTYPE html>
<html>
    <head>
                        ...
                        <div class="col-md-12">
                          <div class="box box-primary">
                            <div class="box-header with-border">
                              ...
                              <a href="ticket_department.php"><button class="btn btn-primary pull-right btn-sm"><i class="fa fa-plus"></i>&nbsp; Add Department</button></a>
                            </div>
                            <div class="container">
                              ...
                              <div class="box-body">
                                <table id="datatable" class="table table-bordered table-striped" style="width:100%">
                                  ...
                                  <tbody>
                                    <?php
                                      $query = "SELECT * FROM tbl_ticket_department WHERE add_uid = '$uid_department'";
                                                ...
                                                <div class="btn-group">
                                                  <button type="button" class="btn btn-info btn-sm"><b>Choose</b></button>
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                      <li><a href="ticket_department.php?EID=<?php echo encrypt($row['id']); ?>"><i class="fa fa-edit" ></i> &nbsp;Edit</a></li>
