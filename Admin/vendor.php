<?php
    ...
    $id = decrypt($_GET["VID"]);
    $query = "SELECT * FROM tbl_vendor WHERE id = '$id'";
                                    ...
                                    <form role="form" method="post" id="customer_form" class="form-horizontal" action="#" onsubmit="return submitForm();" enctype="multipart/form-data">
                                      ...
                                      <div class="box-body">
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-4">
                                            <input type="text" class="form-control" id="first_name" value="<?php echo (isset($id) ? $row['first_name'] : ''); ?>" name="first_name" placeholder="Enter First Name Here" required="required">
                                          </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-4">
                                            <input type="email" class="form-control" id="email" value="<?php echo (isset($id) ? $row['email'] : ''); ?>" name="email" placeholder="Enter Email Here" autocomplete="off">  
                                          </div>
                                        </div>
