<?php
    ...
    $id = decrypt($_GET["EID"]);
    $query = "SELECT * FROM tbl_department WHERE status = '1' and id = '$id'";
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                ...
                                <div class="container">
                                    <form role="form" method="post" class="form-horizontal" id="department_form" action="#" onsubmit="return submitForm();">
                                      <input type="hidden" name="id" id="hidden_id" value="<?php echo (isset($id) ? $id : ''); ?>" />
                                      <div class="box-body">
                                        <div class="form-group">
                                          <label for="department_code" class="control-label col-md-2">Department Code  </label>
                                          <div class="col-md-4">
                                            <input type="text" class="form-control" id="department_code" value="<?php echo (isset($id) ? $row['department_code'] : ''); ?>" name="department_code" placeholder="Enter Department Code Here">
                                          </div>
                                          <label for="department_name" class="col-md-2 control-label">Department Name  </label>
                                          <div class="col-md-4">
                                            <input type="text" class="form-control" id="department_name" value="<?php echo (isset($id) ? $row['department_name'] : ''); ?>" name="department_name" placeholder="Enter Department Name Here" >
                                          </div>
                                        </div>
                                      </div>
