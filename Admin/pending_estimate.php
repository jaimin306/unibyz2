                            ...
                            <div class="container">
                              ...
                              <div class="box-body">
                                <table id="datatable" class="table table-bordered table-striped" style="width:100%">
                                  ...
                                  <tbody>
                                    <?php
                                      $query = "SELECT te.*,tu.first_name,tu.last_name,two.work_order_name FROM tbl_estimate te LEFT JOIN tbl_user tu ON tu.id = te.customer_id LEFT JOIN tbl_work_order two ON two.id = te.work_order_id  WHERE te.status = '1' AND te.estimate_status = '0' AND te.add_uid = '$uid_estimate'";
