...
if (!empty($_GET['status'])) {
    switch ($_GET['status']) {
        case 'success':
            ...
            $statusMsg      = 'Work Order Added Successfully';
            break;
        case 'usuccess':
            $statusMsgClass = 'alert-success';
            $statusMsg      = 'Work Order Updated Successfully';
            break;
        case 'dsuccess':
            $statusMsgClass = 'alert-success';
            $statusMsg      = 'Work Order Deleted Successfully';
            break;
        case 'error':
            $statusMsgClass = 'alert-danger';
            $statusMsg      = 'Error In Work Order... Please Try Again';
            break;
        default:
            $statusMsgClass = '';
            $statusMsg      = '';
                        ...
                        <div class="col-md-12">
                          <div class="box box-primary">
                            <div class="box-header with-border">
                              <h3 class="box-title">All Work Order</h3>
                              <a href="work_order.php"><button class="btn btn-primary pull-right btn-sm"><i class="fa fa-plus"></i>&nbsp; Add Work Order</button></a>
                            </div>
                            <div class="container">
                              ...
                              <div class="box-body">
                                <table id="datatable" class="table table-bordered table-striped" style="width:100%">
                                  ...
                                  <tbody>
                                    <?php
                                      $query = "SELECT two.*,tu.first_name,tu.last_name,tu1.first_name as fname,tu1.last_name as lname FROM tbl_work_order two LEFT JOIN tbl_user tu ON tu.id = two.customer_id LEFT JOIN tbl_user tu1 ON tu1.id = two.resource_id WHERE two.add_uid = '$uid_wo'";
                                        ...
                                        while($row = mysqli_fetch_assoc($res)){
                                          ?>
                                            <tr>
                                              ...
                                              <td><?php echo $row["work_order_name"]; if($row["photo_path"] != ""){echo '<br><a data-fancybox="gallery" href="../uploads/WorkOrder/'.$row["photo_path"].'"><img src="../uploads/WorkOrder/'.$row["photo_path"].'" height="70px" width="75%"/></a>';}?></td>
                                                ...
                                                <div class="btn-group">
                                                  <button type="button" class="btn btn-info btn-sm"><b>Choose</b></button>
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                      <li><a href="work_order.php?EID=<?php echo encrypt($row['id']); ?>"><i class="fa fa-edit" ></i> &nbsp;Edit</a></li>
