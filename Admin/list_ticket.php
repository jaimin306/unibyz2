...
if (!empty($_GET['status'])) {
  ...
  $data = GetRecord('tbl_all_setting','user_id',$uid_ticket);
?>
<!DOCTYPE html>
<html>
    <head>
                        ...
                        <div class="col-md-12">
                          <div class="box box-primary">
                            <div class="box-header with-border">
                              ...
                              <a href="ticket.php"><button class="btn btn-primary pull-right btn-sm"><i class="fa fa-plus"></i>&nbsp; Add Incident</button></a>
                            </div>
                            <div class="container">
