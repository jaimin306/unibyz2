                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                ...
                                <div class="container">
                                    <form role="form" method="post" class="form-horizontal" id="employee_form" action="#" onsubmit="return submitForm();" enctype="multipart/form-data">
                                      ...
                                      <div class="box-body">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <label for="repeat_password" class="col-md-2 control-label">Repeat Password <span class="text-danger">*</span></label>
                                          <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                          <label for="user_type" class="col-md-2 control-label">Role <span class="text-danger">*</span>  </label>
                                          <div class="col-md-4">
                                            <select name="user_type" id="user_type" class="form-control" required>
                                              <option value="">Please Select Role</option>
                                              <option value="3" <?php if($row["user_type"] == "3"){ echo 'selected="selected"';} ?>>Project Manager</option>
                                              <option value="4" <?php if($row["user_type"] == "4"){ echo 'selected="selected"';} ?>>Employee</option>
                                            </select>
                                          </div>
                                          <label for="tax_id_no" class="col-md-2 control-label">SSN/Tax ID </label>
                                          <div class="col-md-4">
                                            <input type="text" class="form-control" id="tax_id_no" value="<?php echo (isset($id) ? $row['tax_id_no'] : ''); ?>" name="tax_id_no" placeholder="Enter SSN/Tax ID Here" >
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <label for="emp_id" class="col-md-2 control-label">Employee ID  </label>
                                          <div class="col-md-4">
                                            <input type="text" class="form-control" id="emp_id" value="<?php echo (isset($id) ? $row['emp_id'] : ''); ?>" name="emp_id" placeholder="Enter Employee ID Here"  >
                                          </div>
                                      ...
                                      <div class="box-footer">
                                        <?php
                                        if(isset($id) && $id != "" ){
                                          echo '<button type="submit" class="btn btn-primary col-sm-offset-2 btn_submit">Update</button>';
                                        }
                                        else{
                                          echo '<button type="submit" class="btn btn-primary col-sm-offset-2 btn_submit">Save</button>';
                                        }
                                        ?>
                                      </div>
                                    </form>
        ...
        <script type="text/javascript">
            $(function () {
              ...
              $('#password, #repeat_password').on('keyup', function () {
                  if($("#password").val() == "" || $("#repeat_password").val() == ""){ $("#message").html('');  return false; }
            ...
            function submitForm() {    
                ...
                if(formid != "" && formid != "0"){
                  ...
                  $.ajax({
                      ...
                      success:function(data){
                          if(data.result == "true"){
                              window.location.href="list_employee.php?status="+(data.status);
                          }
                          else{
                              window.location.href="list_employee.php?status="+(data.status);
                          }
